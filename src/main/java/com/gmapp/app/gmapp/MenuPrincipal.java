...
import com.gmapp.app.altacontratos.ModeloAltaContratos;
import com.gmapp.app.altacontratos.VistaAltaContratos;
import com.gmapp.app.registrohorario.ModeloRegistroHorario;
import com.gmapp.app.registrohorario.VistaRegistroHorario;
import com.gmapp.app.variacioncontratos.ModeloVariacionesContratos;
import com.gmapp.app.variacioncontratos.VistaVariacionesContratos;
import com.gmapp.common.SystemPrintServices;
import com.gmapp.common.ReadPathFromXML;
import com.gmapp.utilities.BaseDeDatos;
import com.gmapp.utilities.PictureUtils;
import java.io.File;
...
public class MenuPrincipal extends javax.swing.JFrame {
    ...
    public MenuPrincipal() {
        ...
        limpiarTemporales();
        SystemPrintServices servicios = new SystemPrintServices();
        iVentanasAbiertas = 0;
    }
...
//            System.out.println(dir + File.separator + archivo);
    ...
    private void btNewCttoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btNewCttoMouseClicked
        if (btNewCtto.isEnabled())
        {
            ...
            ModeloAltaContratos modeloAC = new ModeloAltaContratos();
            VistaAltaContratos vista = new VistaAltaContratos(modeloAC);
            try{
                ...
                //v.setIconImage (new ImageIcon(getClass().getResource("GMapp_PNG_64x64.png")).getImage());
    ...
    private void btImpRegHorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btImpRegHorMouseClicked
        if (btImpRegHor.isEnabled())
        {
            ...
            iVentanasAbiertas = iVentanasAbiertas + 1;
            ModeloRegistroHorario modeloRH = new ModeloRegistroHorario();
